...
```
GMR/
├── general_motion_retargeting/     # Core GMR package
│   ├── motion_retarget.py         # Main retargeting class
│   ├── kinematics_model.py        # Robot kinematics
│   ├── data_loader.py             # Motion data loading
│   ├── ik_configs/                # IK configuration files
│   └── utils/                     # Utility functions
├── scripts/                        # Retargeting scripts
│   ├── smplx_to_robot.py         # SMPL-X to robot
│   ├── bvh_to_robot.py           # BVH to robot
│   ├── gvhmr_to_robot.py         # GVHMR to robot
│   ├── fbx_offline_to_robot.py   # FBX to robot
│   └── dash/                      # DASH robot scripts
├── assets/                        # Robot models and data
│   ├── body_models/               # Human body models
│   ├── DASH_URDF/                 # DASH robot assets
│   └── [other_robot_assets]/      # Other robot assets
├── motion_data/                   # Motion capture data
│   ├── ACCAD/                     # ACCAD dataset
│   ├── CMU/                       # CMU dataset
│   └── [other_datasets]/          # Other motion data
├── docs/                          # Documentation
│   └── dash/                      # DASH robot documentation
├── configs/                       # Configuration files
│   └── dash/                      # DASH robot configurations
└── test_results/                  # Test results and motion data
    └── dash/                      # DASH robot test results
```
